...
from model.Listing_Model import Listing_Model


PROPERTY_DATA_FILE = "/usr/app/src/data/estate_data.csv"

def load_listings(search_query: str, sale_type=None, num_beds=None):
    
    model = joblib.load("/usr/app/src/model/listing_model.pkl")
    # Make predictions
...
def display_results(df):
    df_contact = pd.read_csv("/usr/app/src/data/contact_data.csv")
